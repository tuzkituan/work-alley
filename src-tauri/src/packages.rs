...
const CATALOG: &[Entry] = &[
    ...
    // --- mobile ---------------------------------------------------------------
    //
    // The group most people arrive needing and the one the catalog had nothing for.
    // Two of these are honest non-entries: Flutter and the Android SDK are archive
    // downloads with a licence step, and pretending a package manager installs them
    // would be a button that fails. The row still earns its place — it reports
    // whether the tool is on PATH, which is the question the Run button asks.
    Entry { id: "flutter", label: "Flutter SDK", description: "Flutter and the Dart SDK that ships with it.", group: "Mobile", manager: Manager::System, package: "flutter", aliases: &[("dnf", ""), ("apt-get", ""), ("zypper", ""), ("apk", ""), ("pacman", "flutter"), ("brew", "flutter"), ("winget", "Google.Flutter")], bin: "flutter", removable: true, platforms: EVERYWHERE, manager_windows: None, bin_windows: "", unavailable_note: Some("Flutter is a git checkout, not a package: follow docs.flutter.dev/get-started, then run `flutter doctor`.") },
    Entry { id: "dart", label: "Dart SDK", description: "Dart on its own, for packages that are not Flutter apps.", group: "Mobile", manager: Manager::System, package: "dart", aliases: &[("dnf", ""), ("apt-get", ""), ("zypper", ""), ("apk", ""), ("pacman", "dart"), ("brew", "dart-sdk"), ("winget", "Google.DartSDK")], bin: "dart", removable: true, platforms: EVERYWHERE, manager_windows: None, bin_windows: "", unavailable_note: Some("The Flutter SDK already includes Dart — install that instead unless you need Dart alone. Otherwise see dart.dev/get-dart.") },
    Entry { id: "android-sdk", label: "Android command-line tools", description: "adb, sdkmanager and the platform tools Flutter and React Native build through.", group: "Mobile", manager: Manager::System, package: "android-tools", aliases: &[("dnf", "android-tools"), ("apt-get", "android-sdk-platform-tools"), ("zypper", "android-tools"), ("apk", ""), ("brew", "android-platform-tools"), ("winget", "Google.AndroidStudio")], bin: "adb", removable: true, platforms: EVERYWHERE, manager_windows: None, bin_windows: "", unavailable_note: Some("Platform tools give you adb; a full SDK with build-tools and licences comes from Android Studio or `sdkmanager`.") },
    Entry { id: "cocoapods", label: "CocoaPods", description: "iOS dependency manager, used by React Native and Flutter on macOS.", group: "Mobile", manager: Manager::System, package: "cocoapods", aliases: &[("dnf", ""), ("apt-get", ""), ("pacman", ""), ("zypper", ""), ("apk", ""), ("brew", "cocoapods"), ("winget", "")], bin: "pod", removable: true, platforms: UNIX_ONLY, manager_windows: None, bin_windows: "", unavailable_note: Some("CocoaPods is macOS-only: it drives Xcode, which does not exist here.") },
    Entry { id: "watchman", label: "Watchman", description: "File watcher React Native's Metro bundler uses on large trees.", group: "Mobile", manager: Manager::System, package: "watchman", aliases: &[("dnf", ""), ("apt-get", ""), ("pacman", "watchman"), ("zypper", ""), ("apk", ""), ("brew", "watchman"), ("winget", "")], bin: "watchman", removable: true, platforms: UNIX_ONLY, manager_windows: None, bin_windows: "", unavailable_note: Some("Watchman has no package on this distribution; Metro works without it, only slower.") },
    Entry { id: "eas-cli", label: "EAS CLI", description: "Expo's build and submit CLI.", group: "Mobile", manager: Manager::NpmGlobal, package: "eas-cli", aliases: &[], bin: "eas", removable: true, platforms: EVERYWHERE, manager_windows: None, bin_windows: "", unavailable_note: None },

    // --- jvm and .net ---------------------------------------------------------
    Entry { id: "gradle", label: "Gradle", description: "Build tool for Android, Java and Kotlin projects.", group: "Build", manager: Manager::System, package: "gradle", aliases: &[("apk", ""), ("winget", "Gradle.Gradle")], bin: "gradle", removable: true, platforms: EVERYWHERE, manager_windows: None, bin_windows: "", unavailable_note: Some("Most repos ship a `gradlew` wrapper and need no system Gradle at all.") },
    Entry { id: "maven", label: "Maven", description: "Build and dependency tool for Java projects.", group: "Build", manager: Manager::System, package: "maven", aliases: &[("apt-get", "maven"), ("apk", ""), ("winget", "Apache.Maven")], bin: "mvn", removable: true, platforms: EVERYWHERE, manager_windows: None, bin_windows: "", unavailable_note: None },
    Entry { id: "dotnet", label: ".NET SDK", description: "The dotnet CLI, for C# projects.", group: "Languages", manager: Manager::System, package: "dotnet-sdk-8.0", aliases: &[("apt-get", "dotnet-sdk-8.0"), ("pacman", "dotnet-sdk"), ("zypper", "dotnet-sdk-8.0"), ("apk", "dotnet8-sdk"), ("brew", "dotnet"), ("winget", "Microsoft.DotNet.SDK.8")], bin: "dotnet", removable: true, platforms: EVERYWHERE, manager_windows: None, bin_windows: "", unavailable_note: None },
    Entry { id: "composer", label: "Composer", description: "PHP dependency manager.", group: "Languages", manager: Manager::System, package: "composer", aliases: &[("apk", ""), ("winget", "")], bin: "composer", removable: true, platforms: EVERYWHERE, manager_windows: None, bin_windows: "", unavailable_note: Some("On Windows, use the installer from getcomposer.org.") },
    Entry { id: "bundler", label: "Bundler", description: "Ruby dependency manager. Needs Ruby first.", group: "Languages", manager: Manager::System, package: "rubygem-bundler", aliases: &[("apt-get", "ruby-bundler"), ("pacman", "ruby-bundler"), ("zypper", "ruby3.3-rubygem-bundler"), ("apk", ""), ("brew", ""), ("winget", "")], bin: "bundle", removable: true, platforms: EVERYWHERE, manager_windows: None, bin_windows: "", unavailable_note: Some("Bundler ships with modern Ruby; if it is missing, `gem install bundler`.") },
